...
public class SandDupe extends JavaPlugin implements Listener {
    @Override
    public void onEnable() {
        super.onEnable();
        getServer().getPluginManager().registerEvents(this, this);
        getServer().getLogger().info("SandDupe plugin started");
    }

    @Override
    public void onDisable() {
        super.onDisable();
        getServer().getLogger().info("SandDupe plugin stopped");
    }
    ...
    public void onFallingBlockToBlock(EntityChangeBlockEvent e){
        if(e.getEntityType() == EntityType.FALLING_BLOCK){
            ...
            if(movingTo != null && movingTo.getType() == Material.END_PORTAL){
                ...
                vel.setY(-vel.getY());
                dummy.setVelocity(vel.multiply(2));
            }
        }
    }
